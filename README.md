...
## Where do we meet?
See the below table. For those we cannot physically join us, we will set up a Zoom link to log in up to 10 min before the session.
